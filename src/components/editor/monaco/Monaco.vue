...
import { initMonaco } from '../../../utils/monaco/env'
import { getOrCreateModel } from '../../../utils/monaco/utils'
import { type EditorMode, injectKeyStore } from '../../../type/types'
...
onMounted(async () => {
  const theme = await import('../../../utils/monaco/highlight').then((r) => r.registerHighlighter())
  ready.value = true
  await nextTick()
